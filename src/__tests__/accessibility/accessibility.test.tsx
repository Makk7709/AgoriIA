...
describe('Accessibility Tests', () => {
  ...
  // Test des contrastes
  it('Text contrast should meet WCAG AA standards', async () => {
    const { container } = render(
      <div>
  ...
  // Test des landmarks
  it('Page should have proper landmarks', async () => {
    const { container } = render(
      <div>
        <header role="banner">
          <nav role="navigation">
  ...
  it('Interactive elements should have proper ARIA attributes', async () => {
    const { container } = render(
      <div>
